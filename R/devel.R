...
## full <- mgcv::gam(y ~ s(x, bs = "ps", k = 260) + s(x, bs = "ps", k = 260, by = z), sp = rep(36.82, 2), knots = list(k, k), family = nb(theta = 3.1))
## left <- mgcv::gam(c(y1[1:2660], y2[1:2660]) ~ s(x1, bs = "ps", k = 135) + s(x1, bs = "ps", k = 135, by = z1), sp = rep(36.82*139/264, 2), knots = list(k[1:139], k[1:139]), family = nb(theta = 3.1))
## right <- mgcv::gam(c(y1[2541:5200], y2[2541:5200]) ~ s(x2, bs = "ps", k = 135) + s(x2, bs = "ps", k = 135, by = z1), sp = rep(36.82*139/264, 2), knots = list(k[126:264], k[126:264]), family = nb(theta = 3.1))
